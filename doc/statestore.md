...
类的对象，而在该类的构造函数中会调用CopyOnWriteStateTable的getStateMapSnapshotList()方法，该方法会调用所有的CopyOnWriteStateMap的stateSnapshot()
方法来生成CopyOnWriteStateMapSnapshot并保存到list中。
